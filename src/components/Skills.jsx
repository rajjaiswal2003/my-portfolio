    ...
    return (
        <section id="skills">
            <div className="container">
                <h2 style={{ fontSize: 'var(--h2-size)', marginBottom: '3rem', textAlign: 'center' }}>Skills & Expertise</h2>
                <div style={{
                    display: 'grid',
                        ...
                        <div key={index} className="glass" style={{ padding: '2rem', borderRadius: '1.5rem' }}>
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                                {cat.skills.map(skill => (
                                    <span key={skill} style={{ padding: '0.5rem 1rem', borderRadius: '0.5rem', background: 'rgba(255,255,255,0.05)', fontSize: '0.85rem', border: '1px solid rgba(255,255,255,0.1)' }}>
                                        {skill}
                                    </span>
                                ))}
                            </div>
